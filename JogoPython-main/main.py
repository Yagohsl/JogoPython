...
personagens_disponiveis = {
    "anakin": {
        ...
        "imagem": pygame.image.load("assets/images/icons/fighter1.png"),
        "classe": FighterConstructor.Anakin
    },
    "obiwan": {
        "nome": "Obi-Wan Kenobi",
        "imagem": pygame.image.load("assets/images/icons/fighter2.png"),
...
mapas_disponiveis = {
    "templo": {
        "nome": "Templo Jedi",
        "imagem": pygame.image.load("assets/images/jogo/background.png"),
        "caminho": "assets/images/jogo/background.png"
    },
    "mustafar": {
        "nome": "Mustafar",
        "imagem": pygame.image.load("assets/images/jogo/background2.png"),
        "caminho": "assets/images/jogo/background2.png"
    },
    "kamino": {
        "nome": "Kamino",
        "imagem": pygame.image.load("assets/images/jogo/background3.png"),
        "caminho": "assets/images/jogo/background3.png"
    }
}
